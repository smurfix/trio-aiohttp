...
project = 'trio-aiohttp'
copyright = 'The trio-aiohttp authors'
author = 'The trio-aiohttp authors'
...
import trio_aiohttp
version = trio_aiohttp.__version__
...
htmlhelp_basename = 'trio-aiohttp-doc'
...
latex_documents = [
    (master_doc, 'trio-aiohttp.tex', 'Trio Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'trio-aiohttp', 'trio-aiohttp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'trio-aiohttp', 'trio-aiohttp Documentation',
     author, 'trio-aiohttp', 'Helpers for running aiohttp under Trio',
     'Miscellaneous'),
]
