...
if [ "$CHECK_FORMATTING" = "1" ]; then
    ...
    if ! yapf -rpd setup.py trio_aiohttp; then
        cat <<EOF
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
Formatting problems were found (listed above). To fix them, run
   ...
   pip install yapf==${YAPF_VERSION}
   yapf -rpi setup.py trio_aiohttp
...
if [ "$CHECK_DOCS" = "1" ]; then
    ...
    pytest -W error -ra -v --pyargs trio_aiohttp --cov=trio_aiohttp --cov-config=../.coveragerc --verbose
